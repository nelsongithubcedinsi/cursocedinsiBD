...
CREATE TABLE `tipocomponente` (
  `id_tipocomponente` smallint NOT NULL,
  `nombretipocomponente` varchar(50) DEFAULT NULL,
...
INSERT INTO `tipocomponente` VALUES (1,'Agua','ml'),(2,'Malta','ml'),(3,'Lúpulo','ml'),(4,'Levadura','gr'),(5,'Cereal','gr');
